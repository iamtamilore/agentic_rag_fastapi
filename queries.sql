...
VALUES %s
ON CONFLICT (patient_id, event_date, content) DO NOTHING;
...
SELECT content FROM medical_events
WHERE patient_id = %s
...
INSERT INTO query_logs (patient_id, user_question, retrieved_context, llm_answer)
VALUES (%s, %s, %s, %s);
